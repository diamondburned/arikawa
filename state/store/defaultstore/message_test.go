...
func populate12Store() *Message {
	...
	store.MessageSet(discord.Message{ID: 11, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 9, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 7, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 5, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 3, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 1, ChannelID: 1}, false)

	// Try to insert newer messages after inserting new messages.
	store.MessageSet(discord.Message{ID: 12, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 10, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 8, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 6, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 4, ChannelID: 1}, false)

	// These messages should be discarded.
	store.MessageSet(discord.Message{ID: 2, ChannelID: 1}, false)
	store.MessageSet(discord.Message{ID: 0, ChannelID: 1}, false)
